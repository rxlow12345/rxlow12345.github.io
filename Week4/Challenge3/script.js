...
function show(button_element) {
    ...
    */
    ...
    var funfact = facts[taId];
    var display_funfact = document.getElementById("ta-fun-fact");
    display_funfact.innerText = funfact;
    ...
    var display_img = document.getElementById("ta-photo");
    display_img.src = "photos/" + taId + ".jpg";
    ...
    //get all buttons
    var buttons = document.getElementById("left-child").getElementsByTagName("button")
    for (var i = 0; i < buttons.length; i++){
        buttons[i].style.backgroundColor = "";
        buttons[i].style.color = "";
    }
    var selected = document.getElementById(taId);
